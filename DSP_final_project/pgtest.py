...
class Button_Example:
    ...
    def update_display(self,score):
        ...
        self.Button3.create_button(self.screen, (200,250,135), 320, 135, length,    height,    0,        "HighPass", (0,0,0)) #b
        self.Button4.create_button(self.screen, (200,142,35), 420, 235, length,    height,    0,        "BandStop", (0,0,0)) #h
        self.Button5.create_button(self.screen, (200,142,35), 420, 335, length,    height,    0,        "High BandPass", (0,0,0)) #hb     
        self.Button6.create_button(self.screen, (200,142,35), 320, 435, length,    height,    0,        "Low BandPass", (0,0,0)) #lb         
        self.Button7.create_button(self.screen, (235,100,105), 220, 435, length,    height,    0,        "Vibrato", (0,0,0)) #v
        self.Button8.create_button(self.screen, (200,142,35), 120, 335, length,    height,    0,        "Delay", (0,0,0)) #d
        #n,l,b,h,hb,lb,v,d
        #r,g,b
        pygame.display.flip()
